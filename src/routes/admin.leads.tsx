...
function LeadsPage() {
  ...
  const handleConvertLeadError = useToastErrorHandler({
    fallbackMessage: "Falha ao converter lead.",
  });
      ...
      {!leadsLoading && filtered.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Os leads aparecerão aqui quando visitantes preencherem o formulário de contato no
              site.
            </p>
          </CardContent>
        </Card>
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        {linkedClient ? (
                          <Badge
                            variant="outline"
                            className="gap-1 text-xs text-green-700 border-green-600/30 bg-green-50"
                          >
