    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={() => setShowForm(true)} className="btn-filament gap-2">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card className="filament-top border-border bg-card p-4">
          ...
          <div className="mt-1 font-display text-2xl font-bold">
            {clients.filter((c) => clientOrders(c).length > 0).length}
          </div>
        </Card>
        <Card className="filament-top border-border bg-card p-4">
          <div className="text-xs uppercase tracking-wider text-muted-foreground">
          ...
          <div className="mt-1 font-display text-2xl font-bold">
            {orders.filter((o) => o.clientId).length}
          </div>
        </Card>
      </div>
              ...
              <Card key={c.id} className="filament-top border-border bg-card overflow-hidden">
                ...
                >
                  <div
                    ...
                    style={{ background: "linear-gradient(135deg,#5fa8a3,#8a3a52)" }}
                  >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {cOrders.length > 0 && (
                        <Badge variant="secondary">{cOrders.length} pedidos</Badge>
                      )}
                    </div>
                    <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                      ...
                      {totalGasto > 0 && (
                        <span className="inline-flex items-center gap-1 filament-text font-medium">
                        ...
                        {cOrders.map((o) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {o.precoVenda && (
                                <span className="text-xs font-medium filament-text">
                                  {brl(o.precoVenda * o.quantity)}
                                </span>
                              )}
                            </div>
                          </div>
          ...
          >
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={!form.nome.trim() || mutateAdd.isPending}
              >
                Cadastrar
              </Button>
            </DialogFooter>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          {editClient && (
            ...
            >
              <div className="grid gap-2">
                <Label>Nome *</Label>
                <Input name="nome" defaultValue={editClient.nome} required />
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-2">
                  <Label>WhatsApp</Label>
              ...
              <div className="grid gap-2">
                <Label>Notas</Label>
                <Input name="notas" defaultValue={editClient.notas ?? ""} />
              </div>
              <DialogFooter>
                <Button type="button" variant="outline" onClick={() => setEditClient(null)}>
                  Cancelar
                </Button>
                <Button type="submit" className="btn-filament" disabled={mutateUpdate.isPending}>
                  Salvar
                </Button>
              </DialogFooter>
            </form>
      ...
      >
        <DialogContent className="sm:max-w-sm">
          ...
          <p className="text-sm text-muted-foreground">
            Tem certeza? Os pedidos vinculados não serão excluídos.
          </p>
          <DialogFooter>
            <Button variant="outline" onClick={() => setDeleteId(null)}>
              Cancelar
            </Button>
            <Button variant="destructive" onClick={() => deleteId && mutateRemove.mutate(deleteId)}>
              Remover
            </Button>
          </DialogFooter>
        </DialogContent>
