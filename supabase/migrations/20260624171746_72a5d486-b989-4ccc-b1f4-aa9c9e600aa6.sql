...
-- Grants & RLS: only service_role (admin backend) can touch these tables.
do $$
declare
  t text;
begin
  foreach t in array array[
    'users','filamentos','filamentos_history','orders','portfolio_projects',
    'insumos','vendas','inventory_txns','expenses','leads','clients',
    'app_settings','site_content','filamento_payments','filamento_payment_installments'
  ] loop
